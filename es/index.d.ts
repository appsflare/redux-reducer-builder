...
export interface IReducerBuilder<TState> {
     ...
     */
    handleAsyncAction<TPayload extends IAsyncPayload<TResult, TData>, TResult, TData = any, TMeta = any>(actionCreator: IMetaAsyncActionCreator<TResult, TData, TMeta>, stateHandlers: Partial<IAsyncActionHandler<TState, TPayload, TResult, TData, TMeta>>): IReducerBuilder<TState>;
    /**
     ...
     * @param stateHandlers state handlers to handler three states of an asynchronous action namely pending, fulfilled and rejected
     */
    handleAsyncActions<TPayload extends IAsyncPayload<TResult, TData>, TResult, TData = any, TMeta = any>(actionCreators: IMetaAsyncActionCreator<TResult, TData, TMeta>[], stateHandlers: Partial<IAsyncActionHandler<TState, TPayload, TResult, TData, TMeta>>): IReducerBuilder<TState>;
    /**
...
*/
export declare function createReducerBuilder<TState>(): IReducerBuilder<TState>;
