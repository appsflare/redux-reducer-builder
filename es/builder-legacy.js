    ...
    return {
        ...
        handleAsyncAction: function (actionCreator, stateHandlers) {
            if (stateHandlers.pending) {
                actionHandlers.set(getPendingActionType(actionCreator), stateHandlers.pending);
            }
            if (stateHandlers.fulfilled) {
                actionHandlers.set(getFulFilledActionType(actionCreator), stateHandlers.fulfilled);
            }
...
//# sourceMappingURL=builder-legacy.js.map