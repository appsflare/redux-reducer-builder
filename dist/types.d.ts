...
export declare function createPayloadAction<TType, TPayload>(type: TType): (payload: TPayload) => {
    type: TType;
    payload: TPayload;
};
...
export interface IReducerBuilder<TState> {
     ...
     */
    handleAsyncAction<TPayload extends IAsyncPayload<TResult>, TResult, TData = any, TMeta = any>(actionCreator: IMetaAsyncActionCreatorFactory<TResult, TData, TMeta>, stateHandlers: Partial<IAsyncActionHandler<TState, TPayload, TResult, TMeta>>): IReducerBuilder<TState>;
    /**
     ...
     * @param stateHandlers state handlers to handler three states of an asynchronous action namely pending, fulfilled and rejected
     */
    handleAsyncActions<TPayload extends IAsyncPayload<TResult>, TResult, TData = any, TMeta = any>(actionCreators: IMetaAsyncActionCreatorFactory<TResult, TData, TMeta>[], stateHandlers: Partial<IAsyncActionHandler<TState, TPayload, TResult, TMeta>>): IReducerBuilder<TState>;
    /**
